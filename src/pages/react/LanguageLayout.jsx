...
const LanguageLayout = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
  className={`sidebar w-72 flex flex-col pt-16 z-20 min-h-screen fixed py-6 bg-gradient-to-b from-gray-900 to-gray-800 top-0 left-0 transform ${
...
>
  <div className="w-full px-6">
      ...
      <ul className="space-y-4">
        {filteredContent.map((item, index) => (
          <li
            ...
            key={index}
             // Highlight the topic on selection
            className="group relative flex items-start justify-between p-4 bg-gray-700 hover:bg-gray-600 transition-all duration-300 ease-in-out rounded-lg cursor-pointer shadow-md"
          >
            <div>
    ...
    <div className="mt-10 text-center">
      <button
        onClick={() => setIsOpen(false)}
        className="bg-emerald-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-emerald-400 transition-all duration-300"
      >
        Close Sidebar
      </button>
    </div>
